    ...
    <div className='flex flex-col gap-5 max-w-3xl'>
      ...
      <div className="flex flex-col gap-6">
        {currentElection.categories.map((cat) => {
          const visibleCandidates = cat.candidates.slice(0, 3)
          const remaining = cat.candidates.length - 3
          ...
          return (
            <div key={cat.id} className="rounded-[14px] p-5 border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {c.bio && (
                          <div className="text-[11px] mt-0.5 line-clamp-2" style={{ color: 'var(--text3)' }}>
                            {c.bio}
                          </div>
                        )}
                      </div>
              ...
              {/* Show "+X more" if there are more than 3 candidates */}
              {remaining > 0 && (
                <div className="text-right mt-3">
                  <span className="text-[12px] px-3 py-1 rounded-full" style={{ background: 'var(--surface2)', color: 'var(--text3)' }}>
